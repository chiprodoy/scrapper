...
$e1=new ElementData('url','a[data-sqe="link"]',ElementType::LINK);
...
$s= new Scrapper('https://shopee.co.id/shop/267130746/search?page=0&sortBy=ctime',9999,'.shopee-page-controller',5);
